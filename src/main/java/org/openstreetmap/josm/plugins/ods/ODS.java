 ...
 */
public class ODS {
    private static Map<String, OdsModuleConfig> modules = new HashMap<>();
	private static Map<String, Host> hosts = new HashMap<>();
	private static Map<String, OdsModule> layers = new HashMap<>();
...
//	private static OdsModuleConfig module;

    private static JMenu menu;

//	public static void setModule(OdsModuleConfig module) {
//        ODS.module = module;
//        menu.setText("ODS "+ module.getName());
//    }

//    public static OdsModuleConfig getModule() {
...
//	}
	...
	public static void registerLayer(OdsModule layer)
			throws ConfigurationException {
	...
	public static OdsModule getLayer(String name)
			throws ConfigurationException {
		OdsModule layer = layers.get(name);
		if (layer == null) {
			throw new ConfigurationException(String.format(
					"OdsModule '%s' does not exist", name));
		}
		return layer;
	}
...
//    public static void registerModule(OdsModuleConfig module) {
//        modules.put(module.getName(), module);
//    }
//
//    public static Collection<OdsModuleConfig> getModules() {
