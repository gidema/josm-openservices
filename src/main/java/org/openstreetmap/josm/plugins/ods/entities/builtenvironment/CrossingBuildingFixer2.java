...
@Deprecated
public class CrossingBuildingFixer2 {
    private Building building1;
    private Building building2;
    private final Double tolerance;
    
    public CrossingBuildingFixer2(Double tolerance) {
        super();
            ...
            while (i<coords2.size()) {
                ...
                if (dist != 0 && dist < tolerance) {
                    if (segment.p1.distance(coord1) < tolerance) {
                        ...
                        // If this is the last node in the ring, we need to change
                        // the first node as well
                        if (i == coords2.size()-1) {
                            coords2.set(0, coord1);
                        }
                    }
                    else {
