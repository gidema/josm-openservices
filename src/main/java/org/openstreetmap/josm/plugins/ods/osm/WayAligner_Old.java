...
import org.openstreetmap.josm.plugins.ods.osm.SegmentMatcher_Old.MatchType;
...
public class WayAligner_Old {
    ...
    private SegmentMatcher_Old matcher;

    public WayAligner_Old(Way way1, Way way2,
            Double tolerance, boolean undoable) {
        this.way1 = way1;
        this.way2 = way2;
        this.undoable = undoable;
        this.tolerance = tolerance;
        this.matcher = new SegmentMatcher_Old(tolerance);
    }
