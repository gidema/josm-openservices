...
public class ValueMapperFactory {
    ...
    public ValueMapper<?> createValueMapper(String type, Properties properties)
            throws ValueMapperException {
        Class<? extends ValueMapper<?>> clazz = registry
        ...
        if (clazz != null) {
            ...
            try {
                ...
                throw new ValueMapperException(
                        "Couldn't instantiate ValueMapper", e);
            } catch (IllegalAccessException e) {
                throw new ValueMapperException("Couldn't access ValueMapper",
                        e);
            }
        }
        throw new ValueMapperException(
                String.format("Unknown valueMapper type: %s", type));
    }
}
